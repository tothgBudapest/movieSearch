                        ...
                        <Grid item xs={12} sm container>
                            <Grid item xs container direction="column" spacing={2}>
                                <Grid item xs>
                                    ...
                                    <Typography gutterBottom component="div">
                                        <Button component={Link} target="_blank" rel="noopener" href={wikiData?.url}>
                                            Wikipedia
                                        </Button>
                                        <Button component={Link} target="_blank" rel="noopener" href={imdbData?.url}>
                                            IMDB
                                        </Button>
                                    </Typography>
                                </Grid>
                                <Grid item>
                                    <Button variant="contained">Find similar</Button>
                                </Grid>
                            </Grid>
                        </Grid>
                    </Grid>
